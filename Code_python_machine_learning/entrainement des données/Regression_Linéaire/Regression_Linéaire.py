...
df = df[(df['Parti_Gagnant'] != 'Inconnu') & ( df['Parti_Gagnant'] !='Extrême-gauche') & ( df['Parti_Gagnant'] !='Égalité') ]  # Remplacez 'inconnu' par la valeur exacte si nécessaire
...
# Encodage de toutes les colonnes catégoriques
le = LabelEncoder()
...
# Statistiques descriptives
statistiques_descriptives = df.describe(include='all')
statistiques_descriptives.to_csv('statistiques_descriptives.csv')
print("Statistiques descriptives enregistrées dans 'statistiques_descriptives.csv'.")
...
with open('logistic_regression_performance.txt', 'w') as f:
    f.write(f"Accuracy: {accuracy}\n\n")
    f.write("Classification Report:\n")
    f.write(classification_rep)
    f.write("\nConfusion Matrix:\n")
    f.write(str(confusion_mat))
print("Les performances du modèle ont été enregistrées dans 'logistic_regression_performance.txt'.")
...
print("Les prédictions ont été enregistrées dans 'predictions_logistic_regression.csv'.")