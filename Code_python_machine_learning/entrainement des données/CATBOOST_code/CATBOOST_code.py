...
with open('catboost_performance.txt', 'w') as f:
    f.write(f"Accuracy: {accuracy}\n\n")
    f.write("Classification Report:\n")
    f.write(classification_rep)
    f.write("\nConfusion Matrix:\n")
    f.write(str(confusion_mat))
print("Les performances du modèle ont été enregistrées dans 'catboost_performance.txt'.")
...
print("Les prédictions ont été enregistrées dans 'predictions_catboost.csv'.")
